...
export default function PermanentExpenseModal({
  open, onClose, onSave,
  ...
  function validate() {
    ...
    if (!form.dayOfMonth)     e.dayOfMonth = 'Day of month is required.';
    else {
      const d = parseInt(form.dayOfMonth, 10);
      if (isNaN(d) || d < 1 || d > 31) e.dayOfMonth = 'Enter a day between 1 and 31.';
    }
  ...
  function handleSubmit(e) {
    ...
    onSave({
      ...
      cardPay:    form.cardPay,
      cardType:   form.cardPay === 'Yes' ? form.cardType : '',
    });
    onClose();
  }
          ...
          <div style={s.grid}>
            ...
            <div style={s.group}>
              ...
              <input
                ...
                style={{ ...s.input, ...(errors.dayOfMonth ? s.inputError : {}) }}
                value={form.dayOfMonth}
                onChange={e => set('dayOfMonth', e.target.value)}
              />
              {errors.dayOfMonth
                ? <span style={s.errMsg}>{errors.dayOfMonth}</span>
                : <span style={s.hint}>The day each month this expense is charged</span>}
            </div>
...
const s = {
  ...
  saveBtn: {
    ...
    background: 'var(--warning)', color: '#fff', fontSize: 15, fontWeight: 600,
